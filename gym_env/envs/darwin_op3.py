...
class DarwinOp3Env(MujocoEnv, EzPickle):
    ...
    def __init__(
        ...
        forward_velocity_weight: float = 2.5,  # 2.50,
    ...
    def _get_rew(self, velocity):
        ...
        reward = (
            ...
            health_reward + forward_reward + control_cost - pos_deviation_cost - lateral_velocity_cost + stand_penalty
        )
